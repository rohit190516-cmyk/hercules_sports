...
const LocationSection = () => {
  ...
  return (
    <section id="location" className="py-24 md:py-32 section-light-alt relative" aria-label="Store location and contact information">
      <div className="container mx-auto px-4 md:px-8 relative z-10" ref={ref}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="flex gap-4 items-start p-6 border" style={{ backgroundColor: "hsl(var(--light-card))", borderColor: "hsl(var(--light-border))" }}>
              <MapPin className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <div>
                <h3 className="text-sm font-bold font-display tracking-wider mb-1" style={{ color: "hsl(var(--light-fg))" }}>ADDRESS</h3>
                <p className="text-sm font-body leading-relaxed" style={{ color: "hsl(var(--light-muted))" }}>
            ...
            <div className="flex gap-4 items-start p-6 border" style={{ backgroundColor: "hsl(var(--light-card))", borderColor: "hsl(var(--light-border))" }}>
              ...
              <div>
                <h3 className="text-sm font-bold font-display tracking-wider mb-1" style={{ color: "hsl(var(--light-fg))" }}>BUSINESS HOURS</h3>
                <p className="text-sm font-body" style={{ color: "hsl(var(--light-muted))" }}>Open · Closes 9:30 PM</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 border font-display tracking-wider text-sm transition-colors"
                style={{
          ...
          <motion.div
            ...
            className="w-full h-[300px] lg:h-full min-h-[300px] border overflow-hidden"
